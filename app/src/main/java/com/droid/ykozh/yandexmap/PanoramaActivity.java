...
public class PanoramaActivity extends Activity implements PanoramaService.SearchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.droid.ykozh.yandexmap.R.layout.panorama);
        super.onCreate(savedInstanceState);
        panoramaView = (PanoramaView)findViewById(com.droid.ykozh.yandexmap.R.id.panoview);
    ...
    public void onPanoramaSearchError(Error error) {
        ...
        if (error instanceof NotFoundError) {
            errorMessage = getString(com.droid.ykozh.yandexmap.R.string.not_found_error_message);
