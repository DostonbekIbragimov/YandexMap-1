...
public class SearchActivity extends Activity implements Session.SearchListener, CameraListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.droid.ykozh.yandexmap.R.layout.search);
        ...
        searchEdit = (EditText)findViewById(com.droid.ykozh.yandexmap.R.id.search_edit);
        ...
        for (GeoObjectCollection.Item searchResult : response.getCollection().getChildren()) {
            ...
            if (resultLocation != null) {
                mapObjects.addPlacemark(
                        resultLocation,
                        ImageProvider.fromResource(this, com.droid.ykozh.yandexmap.R.drawable.search_result));
            }
        }
    }
